...
export class CertificationController {
    ...
    @ApiResponse({ status: 409, description: 'Un certificat existe déjà pour cette inscription.' })
    ...
    @Get('download/:id')
    @ApiOperation({ summary: 'Télécharger le PDF du certificat et en enregistrer une copie sur le Desktop' })
