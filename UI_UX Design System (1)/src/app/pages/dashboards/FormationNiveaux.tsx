    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-8 space-y-8">
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-1">
                ...
                <p className="font-medium">{formation.description || 'Aucune description'}</p>
              </div>
              <div className="space-y-1">
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-bold">Niveaux de la formation</h2>
          <p className="text-muted-foreground">
            Cliquez sur un niveau pour voir ses séances
          </p>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              ...
                              {niveau.seances && ` • ${niveau.seances.length} séances`}
                            </p>
                          </div>
                        </div>
          ...
          {sortedNiveaux.length === 0 && (
            <div className="flex items-center justify-center py-12">
              <p className="text-muted-foreground">Aucun niveau trouvé pour cette formation</p>
            </div>
          )}
        </div>
      </div>
