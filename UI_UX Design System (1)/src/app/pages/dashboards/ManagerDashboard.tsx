      ...
      <div className="flex-1 mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs defaultValue="dashboard" className="space-y-6">
          <TabsList className="grid w-full grid-cols-4 lg:grid-cols-7 gap-1">
            <TabsTrigger value="dashboard"><BarChart3 className="h-4 w-4 mr-1" />Tableau</TabsTrigger>
            <TabsTrigger value="eleves"><Users className="h-4 w-4 mr-1" />Eleves</TabsTrigger>
            <TabsTrigger value="formations"><BookOpen className="h-4 w-4 mr-1" />Formations</TabsTrigger>
            <TabsTrigger value="seances"><Calendar className="h-4 w-4 mr-1" />Seances</TabsTrigger>
            <TabsTrigger value="inscriptions"><FileText className="h-4 w-4 mr-1" />Inscriptions</TabsTrigger>
            <TabsTrigger value="certifications"><Award className="h-4 w-4 mr-1" />Certificats</TabsTrigger>
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex gap-2 flex-wrap">
                ...
                <Dialog open={isCreateFormOpen} onOpenChange={setIsCreateFormOpen}>
                  <DialogTrigger asChild><Button className="gap-2"><Plus className="h-4 w-4" /> Creer</Button></DialogTrigger>
                  <DialogContent>
