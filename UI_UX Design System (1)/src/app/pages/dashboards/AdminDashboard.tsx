...
export function AdminDashboard() {
  ...
  const stats = [
    {
      ...
      description: `${analytics?.formationsActives || 0} actives, ${analytics?.formationsInactives || 0} inactives`,
      icon: BookOpen,
      trend: undefined,
    },
    {
      ...
      description: 'Nombre de formateurs',
      icon: Users,
      trend: undefined,
    },
    {
  ...
  const inscriptionStatusData = analytics ? [
    { name: 'En cours', value: analytics.inscriptionsByStatus.en_cours, color: 'hsl(var(--primary))' },
    { name: 'Complétées', value: analytics.inscriptionsByStatus.completee, color: 'hsl(var(--success))' },
    { name: 'Abandonnées', value: analytics.inscriptionsByStatus.abandonnee, color: 'hsl(var(--destructive))' },
  ] : [];

  const presenceData = analytics ? [
    { name: 'Présents', value: analytics.presencePresent, color: 'hsl(var(--success))' },
    { name: 'Absents', value: analytics.presenceAbsent, color: 'hsl(var(--destructive))' },
  ] : [];
  ...
  const handleUpdateUser = async () => {
    try {
      ...
      if (!formData.nom || !formData.prenom || !formData.email) {
        toast.error('Veuillez remplir tous les champs (sauf le mot de passe)');
        return;
      }
      ...
      <div className="border-b border-border bg-background">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          ...
          <p className="text-muted-foreground">
            Gestion complète de la plateforme, utilisateurs et paramètres système
          </p>
        </div>
      </div>
        ...
        <Tabs defaultValue="users" className="space-y-6">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="border-b border-border bg-muted/50">
                      <tr>
                        <th scope="col" className="px-6 py-4 text-left font-medium">Utilisateur</th>
                        <th scope="col" className="px-6 py-4 text-left font-medium">Email</th>
                        <th scope="col" className="px-6 py-4 text-left font-medium">Rôle</th>
                            ...
                            <div className="flex gap-1">
                              {(user.role === 'Formateurs' || user.role === 'responsableformation') && (
                                <Button
                                  ...
                                  title={`Passer en ${user.role === 'Formateurs' ? 'Responsable' : 'Formateur'}`}
                                >
              ...
              <>
                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                  ...
                  <Card className="lg:col-span-2">
                    <CardHeader>
                      <CardTitle>Élèves par formation</CardTitle>
                      <CardDescription>Nombre d'élèves inscrits par formation avec statut</CardDescription>
                    </CardHeader>
                    <CardContent>
                      {analytics?.elevesParFormation && analytics.elevesParFormation.length > 0 ? (
                        <ResponsiveContainer width="100%" height={300}>
                          <BarChart data={analytics.elevesParFormation}>
                            ...
                            <YAxis />
                            <Tooltip />
                            <Bar dataKey="enCours" stackId="a" fill="hsl(var(--primary))" name="En cours" />
                            <Bar dataKey="completee" stackId="a" fill="hsl(var(--success))" name="Complétées" />
                            <Bar dataKey="abandonnee" stackId="a" fill="hsl(var(--destructive))" name="Abandonnées" />
                          </BarChart>
                        </ResponsiveContainer>
                      ) : (
                    ...
                    <CardContent>
                      <ResponsiveContainer width="100%" height={250}>
                        <LineChart data={analytics?.monthlyInscriptions || []}>
                          ...
                          <YAxis />
                          <Tooltip />
                          <Line type="monotone" dataKey="inscriptions" stroke="hsl(var(--primary))" strokeWidth={2} name="Inscriptions" dot={{ r: 4 }} />
                        </LineChart>
                      </ResponsiveContainer>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent>
                      <ResponsiveContainer width="100%" height={250}>
                        <BarChart data={analytics?.monthlyEleves || []}>
                          ...
                          <YAxis />
                          <Tooltip />
                          <Bar dataKey="eleves" fill="hsl(var(--success))" name="Élèves" radius={[4, 4, 0, 0]} />
                        </BarChart>
                      </ResponsiveContainer>
                    </CardContent>
                  </Card>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <Card>
                ...
                <CardContent>
                  <ul className="space-y-2 text-sm" role="list">
                    ...
                    <li>✓ Paramètres de la plateforme</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Supervision des formateurs et contenus
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2 text-sm" role="list">
              ...
              <Card>
                ...
                <CardContent>
                  <ul className="space-y-2 text-sm" role="list">
                    ...
                    <li>✓ Upload de ressources</li>
                    <li>✓ Messagerie étudiants</li>
          ...
          <TabsContent value="logs" className="space-y-6">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm text-muted-foreground">{logsTotal} activités au total</span>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="filter-method">Méthode HTTP</Label>
          ...
          <TabsContent value="formations" className="space-y-6">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  aria-label="Actualiser les formations"
                >
            ...
            {formationsLoading ? (
              <div className="flex items-center justify-center py-12" role="status" aria-live="polite">
                <RefreshCw className="h-8 w-8 animate-spin text-muted-foreground" aria-hidden="true" />
                <span className="ml-2 text-muted-foreground">Chargement des formations...</span>
              </div>
            ) : formations.length === 0 ? (
              <Card>
                          ...
                          <div className="mb-6 space-y-4">
                            ...
                            <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                              ...
                              <span className="flex items-center gap-1">
                                ...
                                {formation.seancesValidees}/{formation.totalSeances} séances validées
                              </span>
                            </div>
                                        ...
                                        {niveau.seances.map((seance) => (
                                          ...
                                          >
                                            ...
                                            <div className="flex items-center gap-2 flex-shrink-0 ml-2">
                                              ...
                                              >
                                                {seance.statut ? 'Validée' : 'En attente'}
                                              </Badge>
                                            </div>
                                          </div>
                                        ))}
