...
export class FormationController {
  ...
  @ApiOperation({
    summary:
      'Créer une nouvelle formation (génère automatiquement niveaux et séances)',
  })
  @ApiResponse({
    status: 201,
  ...
  @Get('detailed')
  @ApiOperation({
    summary: 'Récupérer toutes les formations avec niveaux, séances et élèves',
  })
  @ApiResponse({
    status: 200,
    description: 'Liste détaillée des formations récupérée.',
  })
  findAllDetailed() {
  ...
  @Get(':id')
  @ApiOperation({
    summary: 'Récupérer une formation avec sa hiérarchie complète',
  })
  ...
  @Delete(':id')
  @ApiOperation({
    summary: 'Supprimer une formation et tous ses niveaux/séances associés',
  })
  ...
  @ApiOperation({
    summary: 'Récupérer la progression des étudiants basée sur la présence',
  })
  @ApiResponse({
    status: 200,
    description: 'Progression des étudiants récupérée.',
  })
  ...
  @ApiOperation({
    summary: "Récupérer les formations d'un formateur spécifique",
  })
  @ApiResponse({
    status: 200,
    description: 'Formations du formateur récupérées.',
  })
  ...
  @ApiOperation({
    summary: 'Récupérer les élèves inscrits à la formation de la séance',
  })
  ...
  @ApiOperation({
    summary:
      'Valider une formation: certifier les élèves présents et marquer les abandons',
  })
  @ApiResponse({
    status: 200,
    description:
      'Formation validée. Certificats créés pour les élèves éligibles.',
  })
  @ApiResponse({
    status: 400,
    description: 'Tous les niveaux/séances ne sont pas encore terminés.',
  })
  @ApiResponse({ status: 404, description: 'Formation non trouvée.' })
  ...
  @ApiOperation({
    summary:
      'Vérifier les retards des formateurs (>15 min) et envoyer notifications',
  })
  @ApiResponse({
    status: 201,
    description:
      'Vérification terminée. Notifications envoyées aux formateurs en retard.',
    schema: {
      properties: {
        notified: {
          type: 'number',
          description: 'Nombre de formateurs notifiés',
        },
