...
export class InscriptionController {
  ...
  @ApiResponse({
    status: 409,
    description: "L'élève est déjà inscrit à cette formation.",
  })
  ...
  @Patch(':id')
  @ApiOperation({
    summary: "Mettre à jour le statut ou le niveau d'une inscription",
  })
  ...
  @ApiOperation({
    summary: "Récupérer tous les élèves inscrits aux formations d'un formateur",
  })
